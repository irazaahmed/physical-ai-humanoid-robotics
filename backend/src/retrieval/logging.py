...
def setup_logging(level: int = logging.INFO) -> logging.Logger:
    ...
    # Create file handler
    file_handler = logging.FileHandler("retrieval_pipeline.log")
...
class RetrievalError(Exception):
    """Base exception class for retrieval pipeline errors"""
    pass


class QueryProcessingError(RetrievalError):
    """Exception raised for errors in query preprocessing"""
    pass
...
class SearchError(RetrievalError):
    """Exception raised for errors in similarity search"""
    pass
